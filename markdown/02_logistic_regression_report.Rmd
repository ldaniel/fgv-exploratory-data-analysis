...
names(model_1$coefficients) <- stringr::str_sub(names(model_1$coefficients), 1, 35)
...
names(model_2$coefficients) <- stringr::str_sub(names(model_2$coefficients), 1, 35)
...
It only condider the statistic significant variables.
