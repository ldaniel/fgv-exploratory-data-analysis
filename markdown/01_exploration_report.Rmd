...
Regarding the Czech regions, we can notice in the exploration below which regions are more likely to have more defaulters based on the finished operations.
