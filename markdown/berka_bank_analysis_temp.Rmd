...
```{r data_model_pic, echo=FALSE, out.width = '800px', fig.align='center', fig.cap='The logical data model of Berka Bank.'}
...
- **Client**: get gender, birthday and age from birth_number column in using *GetGenderFromBirthnumber* and *GetBirthdateFromBirthnumber* functions;
