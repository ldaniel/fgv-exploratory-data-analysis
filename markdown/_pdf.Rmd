...
![Simplified logical data model of Berka Bank.](../images/data_model.png)
...
```{r loan_district_map_exploration, echo=TRUE, eval=FALSE, out.width = '100%', message=FALSE, warning=FALSE}
...
leaflet(loan_amount_by_region) %>% 
  ...
  addCircles(lng = ~long, 	
             ...
             popup = ~region)
```
![Simplified logical data model of Berka Bank.](../images/LoanDistrictAnalysisMap.png)

*******************************************************************************

# The logistic regression on loan’s report
