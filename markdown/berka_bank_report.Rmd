...
Then, the following command were used in each table to find out where NA values. 
...
Finally, the following command were used in each table to find out where empty values was hidden. 
